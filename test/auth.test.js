...
describe("Auth API", function () {
    ...
    describe("POST /api/auth/register", () => {
        ...
        it("should register a new user successfully", async () => {
            ...
            const res = await request(app)
                ...
                .send({ fullname: "Test User", email: "testuser@test.com", password: "123456" });
        ...
        it("should not register if email already exists", async () => {
            ...
            const res = await request(app)
                .post("/api/auth/register")
                .send({ fullname: "Dup User", email: "duplicate@test.com", password: "123456" });
    ...
    describe("POST /api/auth/login", () => {
        it("should login an existing user successfully", async () => {
            ...
            let user;
            [user] = await userFactory(1, { email: "login@test.com", password: "123456" });
